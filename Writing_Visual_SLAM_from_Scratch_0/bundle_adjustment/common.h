...
class BALProblem {
    public:
        ...
        int num_observations() const { return num_parameters_; }
    ...
    private:
        ...
        int *point_index_;  // point index w.r.t. each observation
        int *camera_index_; // camera index w.r.t. each observation
